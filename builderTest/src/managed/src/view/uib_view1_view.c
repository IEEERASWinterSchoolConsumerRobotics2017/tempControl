...
void view1_button1_onunpressed(uib_view1_view_context*, Evas_Object*, void*);
void view1_button1_onrepeated(uib_view1_view_context*, Evas_Object*, void*);
...
uib_view_context* uib_view_view1_create(Evas_Object* parent, void* create_callback_param) {
	...
	//bind event handler
	evas_object_smart_callback_add(vc->button1, "clicked", (Evas_Smart_Cb)view1_button1_onclicked, vc);
	evas_object_smart_callback_add(vc->button1, "unpressed", (Evas_Smart_Cb)view1_button1_onunpressed, vc);
	evas_object_smart_callback_add(vc->button1, "repeated", (Evas_Smart_Cb)view1_button1_onrepeated, vc);
